...
# Pulls lines from fastq file that contain sequence and puts in a temporary file, changed length to 75 from 50
TMPFILE="tmp"$(date +%s)
grep -e "[AGCTN]\{75,\}" ${ARGS[0]} > $TMPFILE
...
#MIDDLE='...............ATGGTC' #Used for pBAD-EGFP-Lib
MIDDLE='...............ATGGTC' #Used for pBAD-EGFP-Lib
